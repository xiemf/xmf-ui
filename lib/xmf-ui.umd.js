...
// CONCATENATED MODULE: ./packages/input/input.vue?vue&type=template&id=38aaa1b9&
...
var packages_install = function install(Vue) {
  ...
  Vue.component('xInput', packages_input);
  Vue.component('xAffix', packages_affix); // components.forEach(component => {
